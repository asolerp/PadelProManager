...
import {useFirebaseAuth} from '../../../old/Context/FirebaseContext';

import {LoadingModalContext} from '../../../old/Context/LoadingModalContext';
import {defaultFunctions} from '../../Lib/API/firebaseApp';
import {RoleContext} from '../../../old/Context/RoleContext';
