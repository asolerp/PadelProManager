...
export const LiveMatchResume: React.FC<Props> = ({match}) => {
  ...
  return (
    <PressableOpacity
      ...
      <View
        style={[t.flexGrow, t.hFull, t.bgInfo, t.roundedSm, t.p3, t.shadow]}>
        ...
        <View style={[t.flexGrow, t.flexRow, t.mR4]}>
          <View style={[t.flex2, t.justifyCenter]}>
            ...
            <Text ellipsizeMode="tail" numberOfLines={1} style={[cardInfo]}>
              {shortName(
                2,
